...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="h-[30rem] overflow-y-auto flex justify-center relative space-x-10 rounded-md p-10 bg-dark-navy"
      ref={ref}
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20">
              ...
              <motion.p
                ...
                className="text-lg text-white/70 max-w-sm mt-10"
              >
                {item.description}
              </motion.p>
            </div>
